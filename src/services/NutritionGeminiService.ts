...
export const analyzeNutrition = async (
  ...
  try {
    ...
    const responce = await axios.post(`${import.meta.env.VITE_BACKEND_URL_PROD}/nutrition-analysis`, {
      modelType: modelType,
      foodList: foodList
    }, {
      headers: {
...
export const fetchNutritionPlanFromGemini = async (
  ...
  try {
    const controller = new AbortController();
    const responce = await axios.post(`${import.meta.env.VITE_BACKEND_URL_PROD}/nutrition-plan-generation`, {
      modelType: modelType,
      allergies: allergies,
      age: healthData.age,
...
export const fetchRecipeFromGemini = async (
  ...
  try {
    const controller = new AbortController();
    const responce = await axios.post(`${import.meta.env.VITE_BACKEND_URL_PROD}/recipe-generation`, {
      modelType: modelType,
      allergies: allergies,
      mealIdea: mealIdea
    }, {
...
export const getFoodNutritionInfoFromGemini = async (
  ...
  try {
    const controller = new AbortController();
    const responce = await axios.post(`${import.meta.env.VITE_BACKEND_URL_PROD}/food-nutrition-info`, {
      modelType: modelType,
      foodName: foodName
    }, {
      headers: {
...
export const generateMealFromIngredients = async (
  ...
  try {
    ...
    const controller = new AbortController();
    const responce = await axios.post(`${import.meta.env.VITE_BACKEND_URL_PROD}/meal-idea-generation`, {
        modelType:modelType,
